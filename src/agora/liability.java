...
public class liability extends javax.swing.JPanel {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(187, 881, Short.MAX_VALUE)
    ...
    if (selectedRowIndex != -1) {
        ...
        if (input != null && input.matches("-?\\d+(\\.\\d+)?")) {
            ...
            if (paymentAmount == Math.abs(balance)) { // Check if the payment amount is equal to the absolute value of the balance
                ...
                JOptionPane.showMessageDialog(null, "Payment amount doesn't match the balance.");
            }
        } else {
